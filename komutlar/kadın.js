...
if(!['809095577094586407'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '⚝'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '809095577060507663') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '809095577060507662')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '809095577060507659')
const genelchat = message.guild.channels.cache.find(c => c.id === '809095580114616320')
const savelog = message.guild.channels.cache.find(c => c.id === '809095583544377392')
